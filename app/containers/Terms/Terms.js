				...
				<div className={'container narrow'}>
					<div className={'row'}>
						<div className={'col-12'}>
							...
							<p>Frankenbook is a project of the Center for Science and the Imagination at Arizona State University (“ASU”) and the Media Lab and The MIT Press at the Massachusetts Institute of Technology (“MIT”). Frankenbook is a collective reading and collaborative annotation experience of the original text of Frankenstein; or, The Modern Prometheus, by Mary Wollstonecraft Shelley.</p>
							<p>Frankenbook reserves the right to change the terms of the Terms of Service ("TOS") or to modify its features at any time. The Site will post changes to the terms of this User Agreement <a href="/terms">here</a>, and by accessing the Site after modifications to this User Agreement have been posted, you agree to be bound by all the modified terms.</p>
							<h2>Acceptance of Terms</h2>
							<p>By accessing content on the Frankenbook website (the “Site”), which includes all pages within the frankenbook.org host directory and subdomains, and all affiliated services,</p>
							<ol>
							...
							<p>For the purposes of this TOS, the term “Site Content” shall include all content, features, and functionality posted to the Site by Frankenbook as well as User-Generated Content.</p>
							...
							<p>Frankenbook monitors User-Generated Content on the Site, and Frankenbook reserves the right to modify, edit, or remove any of said content at its discretion, without notice, and for any reason. Frankenbook may prescreen User-Generated Content and may decide, in its discretion, without notice, and for any reason, not to publish it. By submitting an annotation to the site, you give Frankenbook permission to edit the content for clarity, factual accuracy, spelling, grammar, and adherence to our house style guide. Frankenbook assumes no liability for monitoring, modifying, removing, or declining to publish User-Generated Content on this Service.</p>
